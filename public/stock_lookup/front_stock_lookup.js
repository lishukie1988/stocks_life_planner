function createSearchBar() {
    ...
    search_div.css({"background": background_day, "margin": "1%"});
...
function createStockDetails() {
    ...
    stock_details_div.css({"background": background_day, "margin": "1%"});
...
function createStockData(data_object) {
    ...
    day_change.append(data_object["price"]["regularMarketChangePercent"]["raw"] + "%");
...
function createBuyWindow() {
    ...
    let buy_window = createDiv("100%", "25%", "left", "");
    buy_window.css({"margin-top": "25%", "background": background_day});
